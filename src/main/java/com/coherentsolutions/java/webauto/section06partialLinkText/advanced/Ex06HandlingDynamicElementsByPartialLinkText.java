...
/**
 * This class demonstrates handling dynamic elements located by their partial link text in the DOM Tree using Selenium WebDriver.
 */
public class Ex06HandlingDynamicElementsByPartialLinkText {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            WebElement dynamicLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.partialLinkText("Partial Link")));
            ...
            System.out.println("Clicked on dynamic link with partial text 'Partial Link'");
        } finally {
            // Close the browser
            driver.quit();
        }
