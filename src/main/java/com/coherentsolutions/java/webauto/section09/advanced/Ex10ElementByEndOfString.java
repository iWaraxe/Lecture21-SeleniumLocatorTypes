...
/**
 * This class demonstrates how to locate an element by the end of its attribute string using CSS selector in Selenium WebDriver.
 */
public class Ex10ElementByEndOfString {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Locate the element by the end of its attribute string
            WebElement header = driver.findElement(By.cssSelector("header[id$='header']"));
