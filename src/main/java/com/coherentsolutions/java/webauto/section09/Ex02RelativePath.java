...
/**
 * This class demonstrates how to locate an element by its relative path using CSS selector in Selenium WebDriver.
 */
public class Ex02RelativePath {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Locate the element by its relative path
