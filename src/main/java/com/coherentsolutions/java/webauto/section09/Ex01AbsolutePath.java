...
/**
 * This class demonstrates how to locate an element by its absolute path using CSS selector in Selenium WebDriver.
 */
public class Ex01AbsolutePath {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Locate the element by its absolute path
            WebElement userName = driver.findElement(By.cssSelector("html body div.main form input#username"));
