...
/**
 * This class demonstrates how to use explicit wait with an element located by its link text in the DOM Tree using Selenium WebDriver.
 */
public class Ex05DomTreeByLinkTextWithExplicitWait {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Locate the element by its link text using explicit wait
