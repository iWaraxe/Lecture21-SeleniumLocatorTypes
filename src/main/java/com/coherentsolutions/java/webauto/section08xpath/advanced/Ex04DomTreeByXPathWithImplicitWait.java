...
/**
 * This class demonstrates how to use implicit wait with elements located by their XPath in the DOM Tree using Selenium WebDriver.
 */
public class Ex04DomTreeByXPathWithImplicitWait {
